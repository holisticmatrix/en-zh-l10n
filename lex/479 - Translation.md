...
他的代码，曾在数十亿台电脑上无声运行；他创造的工具，至今仍是全球用户对抗“卡死”的首选武器。
戴夫·普拉默以其数十年的创造生涯，生动地证明了：**编程，是一条可以耕耘一生、并随着经验累积而愈发深刻的职业路径**。

很多人认为程序员是年轻人的战场，戴夫的故事提供了一个截然不同的范本：他从微软首席工程师的身份荣休后，其创造力与影响力并未减退，反而在更广阔的天地中迸发。

他的人生剧本远比“微软传奇工程师”的标签都更为跌宕与丰盈：

    从高中辍学生、在便利店打工，到重回校园、加入微软，凭借一己之力写出嵌入操作系统核心的工具。
    从对手写机器码的古老痴迷，到如今热情拥抱AI，在自家车库里训练智能体通关经典游戏。

这不仅是一个技术天才的故事，更是一幅关于热爱、耐力与持续进化的蓝图。

---

## 索引

- [Introduction](#开场白--introduction)
...
在与**Lex Fridman**的这次深度对谈中，传奇程序员**Dave Plummer 戴夫·普拉默**敞开心扉，讲述了一段关于**痴迷、创造与自我发现**的非凡旅程。你将听到：

- **初心**：一个11岁男孩如何与第一台电脑“对话”，以及那种想拆解世界、弄清其运行规则的纯粹好奇心，如何驱使他一生。
    
- **迷失&回归 - 非线性路径**：辍学、打工、重返校园 —— 他如何在不遵循常规脚本的人生中，凭借对技术的热爱找到自己的方向。
    
- **当“自闭症”成为超能力**：他如何将常人眼中的“障碍”转化为深度专注的源泉，并逆向学习社交密码，在关系与协作中建立深刻联结。
    
- **从机器码到AI“提示词”**：一位穿越了整个计算时代的“老炮”，如何看待技术的本质与未来？他为何对AI带来的可能性感到由衷兴奋？
    

这远不只是一个关于技术和编程的故事，更是一个关于**如何忠于自己的热爱，亲手构建生命意义**的生动见证。
无论你是否懂编程，都能从戴夫真诚、幽默且充满智慧的分享中，获得关于**创新、韧性与如何走出自我人生道路**的宝贵启发。
<br>

## 开场白 | Introduction
**Lex Fridman：**  
这次对谈的嘉宾是戴夫·普拉默 —— 一位程序员、微软元老级工程师，曾参与开发 Windows 95、NT 和 XP 系统，打造了许多影响深远的技术工具。他的一些作品，至今仍被全球数亿人日常使用，比如我们每个人都再熟悉不过的 **Windows 任务管理器**。没错，就是那个关键时刻“救急”的任务管理器！还有 Windows 系统内置的 ZIP 压缩功能，也出自他手。此外，他将经典的 《三维弹球》 成功移植到 Windows 平台，成为一代人的集体记忆。

如今，退休后的戴夫主持的 YouTube 频道“Dave’s Garage”（戴夫的车库），深受全球程序员与工程师喜爱，强烈推荐大家去关注看看。

他还写了一本关于自闭症与个人成长的书《自闭症百万富翁的秘密》，书中分享了在自闭症特质影响下，如何从容应对人际关系、职业发展与日常生活的真实见解。总而言之，这是一场轻松有趣又充满启发的对话，我们聊编程的过去与未来、谈技术的发展脉络，也聊那些在“车库”里动手创造的美好时光。

这里是《Lex Fridman Podcast》，欢迎通过节目描述中的赞助商信息来支持我们。
亲爱的朋友们，现在有请 —— 戴夫·普拉默。
...
Windows 95是最初16位的Windows 3.1的演进版，而3.1是第一个真正流行的Windows版本。95增加了32位支持、VxD驱动程序和一堆新技术，还有全新的用户界面。在当时是具有革命性的。人们甚至会在夜里排队购买。  
...
Windows 95在我这儿排第二。我认为OS/360是第一名。  
...
## Windows 背后的灵魂人物 | The man behind Windows 
...
So people have come to rely on it because I wrote it to be as reliable as possible. I wasn't worried about the features. It was a basic set of functionality that I wanted in there. I got everything I wanted, but I wanted it to be really robust. And small. And the original was like 87k.
...
Yes. So this shipped initially in NT 4.0.
...
And so I took a shot, and unfortunately, a lot of the code was in Assembly, and I was on a MIPS, so I had to rewrite the code in C so that I could then port it to all the different platforms. At the heart of the game is a huge state engine, and it's like a giant switch statement with, if I remember, like 50 entries in it. And it's got an Easter egg built in. And decoding the state, it's like running a neural network through this thing as you hit it with different states. And I just put it aside and treated it as a black box. So my code runs on top of that and does the drawing and the sound and everything else. But the original game is still running.
...
XP开发末期他们找到我（不确定是否已发布测试版）。原本计划将Office的激活代码适配到Windows，但负责人一再延期。我因为擅长快速解决问题而被选中，最终在DRM团队和密钥算法研究组的协助下，赶在XP发布前完成了这套系统。虽然不清楚具体提升多少收入，但强制验证许可证肯定意义重大。  
...
I wonder what it is. Because it's also annoying.
...
## 开始菜单与任务栏 | Start menu and taskbar		
...
Windows 3确实有蓝屏，但和NT系列的蓝屏完全不是一回事。我问过NT蓝屏的设计者Jon Viert，为什么选白字蓝底。一直有传言说是因为实验室里几十台电脑同时跑压力测试时，蓝屏特别显眼。但真相更简单：他当时用的MIPS固件和Visual SlickEdit编辑器都是这个配色。这样编码、启动、崩溃、重启全程色调统一。  
...
For me, it's been C++ and assembly language. And still to this day, C++ is really what you lean on? Yeah, right now I'm 100% Lua and Python, but that's just a side project I'm working on.
...
Because it allows me to encapsulate my favorite C code in classes. I'm not a big- Well, I actually- Yeah, I'm really a C guy. Although I write two kinds of C++. I write really modern C++ 20 using no pointers, no strings, or no character strings, so there are… you know, it's basically as safe as Rust as far as I'm concerned. Or I write C with classes, which is standard C, but, you know, with polymorphism and encapsulation. That's most of what my code is, but I try to do both.
## 人生中最恐惧的时刻 Scariest time of Dave’s life		
...
## 最好的Windows版本 | Best Windows version		
...
Nice. I love humans so much. Anyway, do you have other favorite kinds of systems like that?

**Dave Plummer:** 我痴迷老硬件。比如修复1960年代的肌肉车、老卡车，还有古董电脑。最近半年特别沉迷PDP-11，已经组装了好几台。  
I like a lot of old hardware. I restore cars, so I do a lot of 1960s muscle cars, cars and trucks. And old computers, so I restore PDP-11s. It's been my fascination and my special interest for the last six months or so, and I've built a number of those.
...
What are we looking at here? What's… So the very top is a PDP-11/70 control panel, which we can largely ignore, and then there's two chassis below that. One has- What are the different knobs? Sorry to ask dumb questions here.

**Dave Plummer:** 用来切换LED显示模式。通常能看到数据总线和地址总线，可以暂停运行，用开关编辑地址总线上的数据，直接往内存里写入内容。  
The knobs, they, uh- … control what view you get of the LEDs. So normally, you see the data bus and you can see the address bus. And you can pause the machine, you can edit the add- address on the bus, and you can deposit stuff into memory with the switches.
...
"伪装"是，可能这个描述不太准确，但它指的是"表现得正常"的行为。也就是说，我如何在社交场合中约束自己，以一种其他神经典型人士能够以正确方式接受和认可的方式行事？你在社交互动中所做的一切，从挥手、做面部表情、语调到姿势，都是一个巨大的刻意为之的行为，而且是项工作。对大多数人来说，这是自然而然的，就是他们的行为方式，而且酷的人做得非常好。但对谱系人士来说，你必须伪装这一切。  
...
PDP-11相关的项目，我正在想办法搞到一个叫RA82的驱动器。那是个14英寸的大家伙，转速3600 RPM，声音听起来像洗衣机。然后我得找到对应的控制卡，写代码，把它集成到驱动里，让整套系统跑起来。  
...
## 最快的编程语言 | Fastest programming language		
...
Is this the one? Oh, so this is it. You're using this for? Oh, so- This machine runs those tests? Okay, you've got to tell me about this project. This is an epic project. So you're comparing the performance of the different programming languages.

**Dave Plummer:** 所有代码都打包成独立的Docker容器同时开跑。现在暂时是Zig语言领先——不过战况很激烈，C++优化一波就能反超，然后Zig那边又不服气地追上来。  
Of all these languages. So they all get built into an individual Docker container, and then they all run. And so- It does, it varies. People will make an improvement to the C++ then it'll pass for a while, and then the Zig guys will get angry and come back and make it faster.

**Lex Fridman:** 具体比的是什么算法？怎么衡量性能差距？  
So what have you learned about which languages? Which language usually wins? So Zig, Rust, C++, C? And what kind of code is being run? What's the piece of code that they're trying to run to measure the performance?

**Dave Plummer:** 规则是在5秒内循环计算1亿以内的质数，必须用筛法，每个数最多占1比特内存。像老古董6502处理器因为只有64K内存，就只能当表演项目参展了。  
So what they're doing is they're solving the primes up to 100 million as many times per second as they can in a five-second loop. No. So you can do anything you want, but it has to be a prime sieve. You're allowed to use one bit per integer at most, so you can't use a byte, which is cheaper and easier. There are a number of rules like that that you have to allocate the memory within your timed loop. And so we have a set of rules and we have some solutions that don't follow the rules like the 6502 because you've only got 64K, you can't do 100 million sieve.

**Lex Fridman:** （翻看数据）Zig第一，后面是Rust、Nim、Haskell……C语言居然比Zig慢一半？连PowerShell都来参赛了？  
I'm looking at a snapshot here from a couple years ago, Zig was at the top, then Rust, then Nim, Haskell. Oh, no, this is not, this is not ordered by slowness, or is it? It is. So C would be 1.5 times as long as Zig. Wow. Okay. Fascinating. Well, it's a super cool project. And we've got in crazy languages like PowerShell. There's a version in PowerShell, and stuff like that.
...
I think the most fun for me is when I build something complex, and I've thought through how it should work, and then I run it and it does work that way. That creates intense satisfaction. So seeing the results come out the way that I planned them and have it work, because it rarely does the first time, but… I never trust that. I always feel like I'm missing something.
...
Oh, that's cool. So you essentially learned Python for this project? So this is a good case study of a great programmer in C++ quickly learning a language.

**Dave Plummer:** 对，我管这叫"感觉流编程"——跟着直觉走。  
Yeah. Yeah, I'm vibe coding my way through it, I guess.

"感觉流编程"这说法真妙。对于已经懂编程的人，用AI生成代码来学习新语言或新思路确实高效，因为你完全能看懂它生成的Python代码。  
...
Yeah. Yeah, it's all pretty self-explanatory once you see it but, you know, creating it from whole cloth is a little different, so.
...
戴夫·普拉默让我们看见：卓越的职业生涯从来不是按图索骥，而是以一生为尺度的即兴创造 —— 始于微光般的好奇，成于无数次调试中的领悟，最终在时光的长河里，被耐心与热爱迭代成独特的生命系统。

他的故事揭示了一个朴素的真理：真正的创造不在于编写完美的经历，而在于有勇气亲手构建你相信的人生。这份构建需要的不是超凡的天赋，而是与自我特质和解的智慧，是将所谓"局限"重新编译为优势的洞察。

在这个追逐速成的时代，戴夫的旅程宛如一个优雅的算法：生命的价值在于运行的深度与美感。每个人都是自己人生的程序员，无论你手中的工具是机器码、C语言、AI，还是任何形式的热爱，都能成为你理解世界并留下印记的方式。

愿这段对话如一个精心设计的函数，在你心中激起回响，唤醒那个始终在场的创造者 —— 毕竟，最重要的代码，始终是活出来的那一行。

致敬Lex，致敬Dave，也致敬每一位正在构建自己故事的人。

<br>
Dave Plummer shows us that an exceptional career is never a journey of following a predetermined map, but an improvisational creation on the scale of a lifetime—ignited by a glimmer of curiosity, forged through countless debugging cycles of understanding, and ultimately, iterated over time by patience and passion into a unique system of life.

His story reveals a simple truth: true creation lies not in writing perfect code, but in the courage to build a life you believe in. This construction requires not transcendent talent, but the wisdom to reconcile with one's own nature—the insight to recompile so-called "limitations" into advantages.

In an era obsessed with quick results, Dave's journey is like an elegant algorithm: the value of a life is measured not by its execution speed, but by the depth and beauty of its execution. Everyone is the programmer of their own life. Whether your tools are machine code, C, AI, or any form of passion, they can become your way of understanding the world and leaving your mark.

May this conversation function like a carefully crafted method, evoking a response within you and awakening the creator who was always present—for the most important code, in the end, is the line that is lived.

<br>
With gratitude to Lex, to Dave, and to all who is crafting the narrative of their own life.
